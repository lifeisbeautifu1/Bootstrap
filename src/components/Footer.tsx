const Footer = () => {
  return (
    <div className="bg-gray-100 w-full">
      <div className="text-gray-500 pt-20 pb-24 px-6 lg:px-0 min-w-[500px] max-w-[600px]  lg:max-w-full lg:w-[90%] mx-auto flex flex-col lg:flex-row gap-10 justify-between">
